...
//Llamado a la clase Formato para traer el registro a eliminar
			...
			<div class="col-md-6">
			  <div class="box">
			    <div class="box-header">
			      <h3 class="box-title">Eliminar Formato</h3>
			    </div>
			    <!-- /.box-header -->
			    <div class="box-body">
			      <table id="example2" class="table table-bordered table-hover">
							<thead>
								<tr>
									<th>¿Quieres Eliminar este Formato?</th>
								</tr>
							</thead>
							<tbody>

							<form class="form-horizontal" name="modFormato" action="../../functions/formato/deleteFormato.php" >
